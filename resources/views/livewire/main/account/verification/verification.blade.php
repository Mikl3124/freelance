            ...
            <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x rtl:divide-x-reverse">
                ...
                <div class="divide-y divide-gray-200 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        {{-- Section header --}}
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900">{{ __('messages.t_verification_center') }}</h2>
                            <p class="mt-1 text-sm text-gray-500">{{ __('messages.t_verification_center_subtitle') }}</p>
                        </div>
                                    ...
                                    <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                        ...
                                        <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                            ...
                                            <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                <a href="{{ url( 'uploads/verifications/' . $verification->uid . '/selfie/' . $verification->file_selfie ) }}" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> {{ __('messages.t_download') }} </a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                            ...
                                            <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                <a href="{{ url( 'uploads/verifications/' . $verification->uid . '/front/' . $verification->file_front_side ) }}" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> {{ __('messages.t_download') }} </a>
                                            </div>
                                        </li>
                                        ...
                                        @if ($verification->document_type !== 'passport')
                                            <li class="ltr:pl-3 rtl:pr-3 ltr:pr-4 rtl:pl-4 py-3 flex items-center justify-between text-sm">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                                                    <a href="{{ url( 'uploads/verifications/' . $verification->uid . '/back/' . $verification->file_back_side ) }}" target="_blank" class="font-medium text-indigo-500 hover:text-indigo-600 text-xs"> {{ __('messages.t_download') }} </a>
                                                </div>
                                            </li>
                                        @endif
                        ...
                        @else
                            ...
                            @if ($currentStep === 1)
                                ...
                                <fieldset>
                                    <legend class="text-xs font-medium text-gray-900 mb-2">{{ __('messages.t_choose_document_type') }}</legend>
                            
                                    <div class="mt-1 bg-white rounded-md shadow-sm -space-y-px">

                                        {{-- Identify card --}}
                                        <label class="rounded-tl-md rounded-tr-md relative border-2 p-4 flex cursor-pointer focus:outline-none ">
                                            <input type="radio" name="document_type" value="id" wire:model.defer="document_type" class="h-4 w-4 cursor-pointer text-indigo-500 border-gray-300 focus:ring-indigo-500" aria-labelledby="document_type_id">
                                            <div class="ltr:ml-3 rtl:mr-3 flex flex-col">
                                                <span id="document_type_id" class="block text-xs font-medium text-gray-900">
                                        ...
                                        {{-- Driver license --}}
                                        <label class="relative border-2 border-t-0 p-4 flex cursor-pointer focus:outline-none ">
                                            <input type="radio" name="document_type" value="driver_license" wire:model.defer="document_type" class="h-4 w-4 cursor-pointer text-indigo-500 border-gray-300 focus:ring-indigo-500" aria-labelledby="document_type_driver_license">
                                            <div class="ltr:ml-3 rtl:mr-3 flex flex-col">
                                                <span id="document_type_driver_license" class="block text-xs font-medium text-gray-900">
                                        ...
                                        {{-- Passport --}}
                                        <label class="rounded-bl-md rounded-br-md relative border-2 border-t-0 p-4 flex cursor-pointer focus:outline-none ">
                                            <input type="radio" name="document_type" value="passport" wire:model.defer="document_type" class="h-4 w-4 cursor-pointer text-indigo-500 border-gray-300 focus:ring-indigo-500" aria-labelledby="document_type_passport">
                                            <div class="ltr:ml-3 rtl:mr-3 flex flex-col">
                                                <span id="document_type_passport" class="block text-xs font-medium text-gray-900">
                            ...
                            @elseif ($currentStep === 2)
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <div class="flex justify-center items-center w-full">
                                                <label for="doc_id_frontside" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                        ...
                                        <div>
                                            <div class="flex justify-center items-center w-full">
                                                <label for="doc_id_backside" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                                        <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-3 w-10 h-10 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                @elseif ($document_type === 'passport')
                                    <div class="grid grid-cols-1 gap-4">
                                        ...
                                        <div>
                                            <div class="flex justify-center items-center w-full">
                                                <label for="doc_passport_frontside" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                                        <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-3 w-10 h-10 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                                                            </svg>
                            ...
                            @elseif ($currentStep === 3)
                                ...
                                <div class="grid grid-cols-2 gap-4" wire:ignore>
                                    ...
                                    {{-- Camera container --}}
                                    <div class="flex items-center justify-center border-dashed border-2 border-gray-200 mt-8 mb-4">
                                ...
                                {{-- Take Snapshot --}}
                                <div>
                                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center ltr:mr-2 rtl:ml-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" x-on:click="snapshot">
                    ...
                    {{-- Actions --}}
                    @if (!$verification)
                        <div class="bg-gray-50 h-20 flex justify-between">
