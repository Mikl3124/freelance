            ...
            <div class="mt-6">
                <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12 text-center">
                        <span class="text-gray-600 text-xs font-medium">{{ __('messages.t_already_have_account') }} <a href="{{ url('auth/login') }}" class="font-bold text-gray-900 underline">{{ __('messages.t_login') }}</a></span>
                    </div>
