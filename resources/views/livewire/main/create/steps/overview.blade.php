<div class="w-full" x-data="window.CQjwMygsGRWknEn" x-init="initialize">
    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        <div class="bg-gray-50 px-8 py-4 rounded-t-md">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_overview') }}</h3>
                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_create_gig_overview_subtitle') }}</p>
                </div>
    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        <div class="bg-gray-50 px-8 py-4" :class="seo.is_enabled ? 'rounded-t-md' : 'rounded-md'">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_seo') }}</h3>
                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_search_engine_gig_preview') }}</p>
                </div>
                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
    ...
    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
        ...
        {{-- Section title --}}
        <div class="bg-gray-50 px-8 py-4 {{ count($faqs) ? 'rounded-t-md' : 'rounded-md' }}">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ml-4 mt-4">
                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_faq') }}</h3>
                    <p class="text-xs font-normal text-gray-400">{{ __('messages.t_create_gig_faq_subtitle') }}</p>
                </div>
                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
