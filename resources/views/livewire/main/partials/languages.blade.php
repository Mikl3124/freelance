<div x-data="window.fQFJfPBWUodMvpD">
    ...
    <div @click="open = !open" class="flex items-center cursor-pointer">
        <img src="{{ url('public/img/flags/'. strtolower($default_country_code) .'.svg') }}" alt="" class="w-4 h-4 ltr:sm:mr-3 rtl:sm:ml-3">
        <span class="text-[13px] font-normal text-gray-400 hover:text-gray-700 hidden sm:inline">{{ $default_language_name }}</span>
    </div>
