        ...
        <header class="bg-gray-50 py-8 rounded-b-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_gig_analytics') }}</h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                     ...
                     <span class="hidden sm:block ltr:mr-3 rtl:ml-4">
                        <a href="{{ url('seller/gigs') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-purple-500">
                    ...
                    {{-- Share gig --}}
                    <span class="hidden sm:block ltr:mr-3 rtl:ml-4">
                        <button id="modals-share-btn" class="inline-flex items-center px-4 py-2 border border-purple-500 rounded-sm shadow-sm text-[13px] font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-50 focus:ring-purple-700">
            ...
            <div class="col-span-12 z-[1]">
                <div class="grid grid-cols-12 sm:gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
                        <div class="relative block border border-gray-100 p-5 mt-6 bg-white rounded-lg intro-x">
                    ...
                    {{-- Total visits --}}
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
                        <div class="relative block overflow-hidden border border-gray-100 p-5 mt-6 bg-white rounded-lg intro-x">
                            <div class="flex flex-wrap gap-3">
                                <div class="ltr:mr-auto rtl:ml-auto">
                                    <div class="text-gray-500 flex items-center leading-3 text-sm font-bold">
                ...
                <div class="bg-white relative block p-8 overflow-hidden border border-gray-100 rounded-lg mb-6">
                    ...
                    <div class="justify-between sm:flex">
                        <div>
                            ...
                            <p class="text-[11px] font-[400] text-gray-400">{{ url('service', $gig->slug) }}</p>
                        </div>
                    ...
                    <div class="border-t border-gray-50 mt-6"></div>
                    ...
                    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                        ...
                        <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                <div class="ml-4 mt-4">
                                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_devices') }}</h3>
                                    <p class="text-xs font-normal text-gray-400">{{ __('messages.t_devices_chart_subtitle') }}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-span-7">
                    <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                        ...
                        <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                            <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                <div class="ml-4 mt-4">
                                    <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_visitors_map') }}</h3>
                                    <p class="text-xs font-normal text-gray-400">{{ __('messages.t_visitors_map_subtitle') }}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-span-12 lg:col-span-7">
                <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_browsers') }}</h3>
                                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_browsers_chart_subtitle') }}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-5">
                <div class="mb-6 bg-white shadow-sm rounded-md border border-b-0 border-gray-200">
                    ...
                    <div class="bg-slate-50 px-8 py-4 rounded-t-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_os') }}</h3>
                                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_os_chart_subtitle') }}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_recent_orders') }}</h3>
                                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_recent_orders_subtitle') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_referrers') }}</h3>
                                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_referrers_subtitle') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                <div class="mb-6 bg-white shadow-sm rounded-md border border-gray-200">
                    <div class="bg-slate-50 px-6 py-4 rounded-md">
                        <div class="ltr:-ml-4 rtl:-mr-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                            <div class="ml-4 mt-4">
                                <h3 class="text-base leading-6 font-black tracking-widest text-gray-600">{{ __('messages.t_cities') }}</h3>
                                <p class="text-xs font-normal text-gray-400">{{ __('messages.t_most_visits_by_cities') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
