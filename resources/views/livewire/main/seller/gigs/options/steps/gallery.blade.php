<div class="w-full" x-data="window.HtBWuUxgpMyrQEM" x-init="initialize">
    ...
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
        ...
        <div class="col-span-12 mb-10">
            <div class="md:flex md:items-center md:justify-between ltr:border-l-8 border-indigo-600 ltr:pl-4 rtl:border-r-8 rtl:pr-4">
                ...
                <div class="mt-4 flex md:mt-0 ltr:md:ml-4 rtl:md:mr-4">
                    ...
                    {{-- Back to gigs --}}
                    <a href="{{ url('seller/gigs') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-sm text-xs font-medium text-gray-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    {{-- View gig --}}
                    <a href="{{ url('service', $gig->slug) }}" target="_blank" class="ltr:ml-3 rtl:mr-3 inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div class="col-span-12 lg:col-span-5">
            ...
            {{-- Video --}}
            @if ($video_link)
                <div class="bg-white rounded-lg shadow-sm border border-gray-10 px-8 py-6" wire:key="section_video">
                ...
                <div class="col-span-12">
                    <div class="relative">
                        ...
                        <input type="text" placeholder="{{ __('messages.t_youtube_placeholder') }}"
                            ...
                            class="block w-full text-xs rounded border-2 pr-10 py-3 pl-3 font-normal {{ $errors->first('video_link') ? 'border-red-500 text-red-600 placeholder-red-400 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500' }}">
