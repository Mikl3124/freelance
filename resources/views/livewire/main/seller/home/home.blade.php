        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_seller_dashboard') }}</h1>
                ...
                <div class="bg-white">
                    <div class="max-w-2xl mx-auto py-16 px-4 text-center sm:py-20 sm:px-6 lg:px-8">
                        <h2 class="text-3xl font-extrabold text-white sm:text-3xl">
                            <span class="block text-gray-900">{{ __('messages.t_boost_ur_productivity') }}</span>
                        </h2>
                        <p class="mt-3 text-sm leading-6 text-gray-500">{{ __('messages.t_boost_ur_productivity_subtitle') }}</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
                        ...
                        <div class="flex flex-col rounded-2xl bg-gray-50">
                            <div class="flex-1 grid items-center relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-base font-bold text-gray-900 text-center">{{ __('messages.t_share_ur_gigs') }}</h3>
                                <p class="mt-8 text-sm text-gray-500 text-center">{{ __('messages.t_tap_into_the_power_of_social_media_text') }}</p>
                            </div>
                            <div class="p-6 bg-blue-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                                <a href="{{ url('seller/gigs') }}" class="text-base font-medium text-blue-700 hover:text-blue-600">{{ __('messages.t_my_gigs') }}<span aria-hidden="true" class="hidden ltr:inline-block"> →</span> <span aria-hidden="true" class="hidden rtl:inline-block"> ←</span></a>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col rounded-2xl bg-gray-50">
                            <div class="flex-1 grid items-center relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-base font-bold text-gray-900 text-center">{{ __('messages.t_get_more_skills') }}</h3>
                                <p class="mt-8 text-sm text-gray-500 text-center">{{ __('messages.t_hone_ur_skills_and_expand_knowledge') }}</p>
                            </div>
                            <div class="p-6 bg-blue-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                                <a href="{{ url('help/contact') }}" class="text-base font-medium text-blue-700 hover:text-blue-600">{{ __('messages.t_contact_us') }}<span aria-hidden="true" class="hidden ltr:inline-block"> →</span> <span aria-hidden="true" class="hidden rtl:inline-block"> ←</span></a>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col rounded-2xl bg-gray-50">
                            <div class="flex-1 grid items-center relative pt-16 px-6 pb-8 md:px-8">
                                ...
                                <h3 class="text-base font-bold text-gray-900 text-center">{{ __('messages.t_become_a_successful_seller') }}</h3>
                                <p class="mt-8 text-sm text-gray-500 text-center">{{ __('messages.t_learn_how_to_create_an_outstanding_service_experience') }}</p>
                            </div>
                            <div class="p-6 bg-blue-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                                <a href="{{ url('help/contact') }}" class="text-base font-medium text-blue-700 hover:text-blue-600">{{ __('messages.t_contact_us') }}<span aria-hidden="true" class="hidden ltr:inline-block"> →</span> <span aria-hidden="true" class="hidden rtl:inline-block"> ←</span></a>
                            </div>
