        ...
        <header class="bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    {{-- Title --}}
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('messages.t_reviews') }}</h1>
                                        ...
                                        <tr wire:key="seller-reviews-id-{{ $review->uid }}">
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block">
                                                    <div>
                                                        <a href="{{ url('seller/reviews/details', $review->uid) }}" class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white hover:bg-gray-50 focus:outline-none focus:ring-0" aria-expanded="true" aria-haspopup="true">
