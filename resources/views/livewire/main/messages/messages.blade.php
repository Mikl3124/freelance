            ...
            <div class="wrapper">
                ...
                <div class="chat-area items-center justify-start pt-12" id="chat-area">
                    <div class="py-14 px-6 text-center text-sm sm:px-14">
                        ...
                        <p class="mt-4 font-semibold text-gray-900">{{ __('messages.t_no_conversation_selected') }}</p>
                        <p class="mt-2 text-gray-500">{{ __('messages.t_no_conversation_selected_subtitle') }}</p>
                    </div>
                </div>
            </div>
        </div>
