                    ...
                    <ol role="list" class="overflow-hidden">
                        ...
                        <li class="relative pb-8">
                            ...
                            <div class="relative flex items-center group">
                                ...
                                <span class="ml-4 min-w-0 flex flex-col">
                                    <span class="text-xs font-semibold tracking-wide uppercase text-indigo-600">Administrator</span>
                                </span>
                            </div>
                        </li>
                        ...
                        <li class="relative pb-8">
                            ...
                            <div class="relative flex items-center group">
                                ...
                                <span class="ml-4 min-w-0 flex flex-col">
                                    <span class="text-xs font-semibold tracking-wide uppercase text-indigo-600">Cron jobs</span>
                                </span>
                            </div>
                        </li>
