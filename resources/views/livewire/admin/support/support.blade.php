<div class="w-full" x-data="window.qMCrFTGlghBsWaU" x-init="init">
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div id="table-options-dropdown-{{ $msg->id }}"
                                    ...
                                    <div class="py-1" role="none">
                                        ...
                                        {{-- Reply --}}
                                        <button x-on:click="setMessageToReply('{{ $msg->id }}')" type="button" class="text-gray-800 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="reply-message-btn">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="ltr:mr-3 rtl:ml-3 h-5 w-5 text-gray-400 group-hover:text-gray-500"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
    ...
    {{-- Reply message modal --}}
    <x-forms.modal id="reply-message" target="reply-message-btn" uid="modal_{{ uid() }}" placement="center-center" size="max-w-xl">
