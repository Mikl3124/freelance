<?php
    ...
    return [
        ...
        "t_register_slide_text_1"                                  => "Boost your <span class='text-indigo-600'>earnings</span> by driving traffic to :app_name",
        "t_register_slide_text_2"                                  => "Find the perfect <span class='text-indigo-600'>freelance</span> services for your business",
        ...
        "t_u_wont_be_able_to_receive_orders_until_date"            => "You won't be able to receive new orders or messages until <span class='font-semibold text-gray-900'>:date</span>",
        ...
        "t_too_many_login_attempts_pls_try_after_seconds"          => "Too many login attempts, Please try again in <span id='countdown-seconds' class='font-black font-[Lato] tracking-widest'>:seconds</span> seconds",
        ...
        "t_more_details_about_this_user"                           => "More details about this user",
