            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    <ul role="list" class="list-disc space-y-6 text-[13px] font-medium text-gray-500">
                        <li class="leading-6">
                            Riverr is available only on CodeCanyon, if you buy it or download it from another websites it's either a spam or an edited version that may contains malwares. We always recommend you to <a href="<?php echo e($purchase_link); ?>" target="_blank" class="text-indigo-600">buy riverr</a> from CodeCanyon to get regulary updates and fast support.
                        </li>
                        <li class="leading-6">
                            We typically respond any message within seconds, minutes or maximum hours, you can contact us on <a href="<?php echo e($purchase_link); ?>" target="_blank" class="text-indigo-600">Codecanyon</a>, email <a href="mailto:MrEdwardHendrix@gmail.com" target="_blank" class="text-indigo-600">MrEdwardHendrix@gmail.com</a> or directly using <a href="https://wa.me/<?php echo e($phone); ?>" target="_blank" class="text-indigo-600">WhatsApp</a> for fast support.
                        </li>
                        <li class="leading-6">
                            Keep your license key (purchase code) always private and don't share it with anyone. We will ask you for this key one time when you contact us to verify it. You can follow this post <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank" class="text-indigo-600">Where Is My Purchase Code?</a> to get your purchase code.
                        </li>
                        <li class="leading-6">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Button::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /Users/mickael/code/riverr/resources/views/livewire/installation/start.blade.php ENDPATH**/ ?>