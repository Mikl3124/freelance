                    ...
                    <ol role="list" class="overflow-hidden">
                        ...
                        <li class="relative pb-8">
                            ...
                            <div class="relative flex items-center group">
                                ...
                                <span class="ml-4 min-w-0 flex flex-col">
                                    <span class="text-xs font-semibold tracking-wide uppercase text-indigo-600">Requirements</span>
                                </span>
                            </div>
                        </li>
                        ...
                        <li class="relative pb-8">
                            ...
                            <div class="relative flex items-center group">
                                ...
                                <span class="ml-4 min-w-0 flex flex-col">
                                    <span class="text-xs font-semibold tracking-wide uppercase text-indigo-600">Database</span>
                                </span>
                            </div>
                        </li>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\TextInput::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /Users/mickael/code/riverr/resources/views/livewire/installation/database.blade.php ENDPATH**/ ?>